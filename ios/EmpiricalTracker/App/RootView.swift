...
/// The five primary destinations, surfaced through a custom floating tab bar
/// (see `FloatingTabBar`) rather than the system `TabView` so the shell matches
/// the redesigned, rounded "glass capsule" look.
enum AppTab: Int, CaseIterable, Identifiable {
    case home, diary, plan, body, settings
...
/// Five-tab shell. Each destination is kept alive in a `ZStack` (toggled via
